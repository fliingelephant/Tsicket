...
=======
            match moment::publish_moment(&sponsor_name, &event_id, &moment.event_name,
            &md5(&(sponsor_name.clone() + &event_id + &now)),&moment.text, &moment.pictures) {
>>>>>>> 14ed18e189bbbcb05c1c69ba47b5e392389250e2
